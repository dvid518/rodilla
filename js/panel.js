...
function renderTabla(lista, tbodyId) {
    ...
    tbody.innerHTML = lista.map(producto => crearFila(producto)).join("")
}

async function loadColeccion(nombreColeccion) {
...
async function iniciarPanel() {
    try {
        ...
        renderTabla(bebidas, "bebidas-tbody")
        renderTabla(postres, "postres-tbody")
        renderTabla(aperitivos, "aperitivos-tbody")
    } catch (error) {
...
const viewCats={tabs:[tabBebidas, tabPostres, tabAperitivos], tablas:[tablaBebidas, tablaPostres, tablaAperitivos]}

viewCats.tabs.forEach((tab, index) => {
