...
function crearFila(reserva) {
    return `
        <tr>
            ...
            <td class="icon trash">
                <button class="btn-delete" data-id="${reserva.id}">
...
const reservaNombre=document.getElementById("productName")
const reservaFecha=document.getElementById("productCategory")
...
async function deleteReserva(id) {
    try {
        ...
        reservaNombre.textContent=reserva.nombre || "Sin nombre"
        reservaFecha.textContent=reserva.fecha+" "+reserva.hora
        pendingDelete=id
        showModal()
    } catch(error) {
        console.error(
